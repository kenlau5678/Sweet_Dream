...
### 关卡设计
- 本作的关卡设计主要使用了紫色、蓝色和红色三种颜色来代表梦境主人不同的情绪：深紫色给人一种忧愁的感觉，蓝色能够让人感到放松，而深红色则能让人产生恐惧。每个关卡的设计都各不相同，深紫色关卡主要以跑酷元素为主，通过机关让玩家产生紧张感；蓝色关卡因其颜色具有放松的视觉效果，整体以朦胧效果呈现；深红色关卡则以压抑的视觉效果为设计目的，通过图案的密集排列呈现。

### 人物设计
- 游戏中的精灵角色采用了拟人化的设计，主要色调以蓝色为主，以此来突出角色的速度感和动态美。

### 怪物设计
- 游戏中的小怪和Boss的设计使用了深红色和深紫色，这与关卡颜色的设计意图相呼应。两种小怪分别采用了虫子和蝙蝠的形象设计，而Boss在第一阶段以盔甲化的形象出现，第二阶段则转变为类似液态的形象，以此形成第一阶段被束缚与第二阶段解放的对比效果。
